...
var _ImperativeTransition = __webpack_require__(6552);
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
/**
...
var _contains = _interopRequireDefault(__webpack_require__(424));
var _listen = _interopRequireDefault(__webpack_require__(8076));
var _ownerDocument = _interopRequireDefault(__webpack_require__(7216));
var _react = __webpack_require__(7294);
var _useEventCallback = _interopRequireDefault(__webpack_require__(7738));
...
var _utils = __webpack_require__(4911);
function _getRequireWildcardCache(nodeInterop) { if (typeof WeakMap !== "function") return null; var cacheBabelInterop = new WeakMap(); var cacheNodeInterop = new WeakMap(); return (_getRequireWildcardCache = function (nodeInterop) { return nodeInterop ? cacheNodeInterop : cacheBabelInterop; })(nodeInterop); }
function _interopRequireWildcard(obj, nodeInterop) { if (!nodeInterop && obj && obj.__esModule) { return obj; } if (obj === null || typeof obj !== "object" && typeof obj !== "function") { return { default: obj }; } var cache = _getRequireWildcardCache(nodeInterop); if (cache && cache.has(obj)) { return cache.get(obj); } var newObj = {}; var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor; for (var key in obj) { if (key !== "default" && Object.prototype.hasOwnProperty.call(obj, key)) { var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null; if (desc && (desc.get || desc.set)) { Object.defineProperty(newObj, key, desc); } else { newObj[key] = obj[key]; } } } newObj.default = obj; if (cache) { cache.set(obj, newObj); } return newObj; }
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
const noop = () => {};
...
var _ownerDocument = _interopRequireDefault(__webpack_require__(7216));
var _canUseDOM = _interopRequireDefault(__webpack_require__(3004));
var _react = __webpack_require__(7294);
...
// EXTERNAL MODULE: ./node_modules/@restart/ui/cjs/Overlay.js
var Overlay = __webpack_require__(7089);
...
const PopoverHeader = /*#__PURE__*/react.forwardRef(({
  ...
  bsPrefix = (0,ThemeProvider/* useBootstrapPrefix */.vE)(bsPrefix, 'popover-header');
...
const PopoverBody = /*#__PURE__*/react.forwardRef(({
  ...
  bsPrefix = (0,ThemeProvider/* useBootstrapPrefix */.vE)(bsPrefix, 'popover-body');
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Component, {
    ref: ref,
    className: classnames_default()(className, bsPrefix),
    ...props
...
var helpers = __webpack_require__(9883);
// EXTERNAL MODULE: ./node_modules/react-bootstrap/esm/getInitialPopperStyles.js
var getInitialPopperStyles = __webpack_require__(3706);
...
const Popover = /*#__PURE__*/react.forwardRef(({
  ...
  const bsDirection = (0,helpers/* getOverlayDirection */.z)(primaryPlacement, isRTL);
  let computedStyle = style;
  if (show && !hasDoneInitialMeasure) {
    computedStyle = {
      ...style,
      ...(0,getInitialPopperStyles/* default */.Z)(popper == null ? void 0 : popper.strategy)
    };
  }
...
var Tooltip = __webpack_require__(3489);
...
function useOverlayOffset(customOffset) {
  ...
  const popoverClass = (0,ThemeProvider/* useBootstrapPrefix */.vE)(undefined, 'popover');
  const tooltipClass = (0,ThemeProvider/* useBootstrapPrefix */.vE)(undefined, 'tooltip');
      ...
      offset: () => {
        ...
        if (overlayRef.current) {
          ...
          if (hasClass(overlayRef.current, tooltipClass)) {
            return Tooltip/* default */.Z.TOOLTIP_OFFSET;
          }
        }
        return [0, 0];
      }
...
const Overlay_Overlay = /*#__PURE__*/react.forwardRef(({
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(Overlay/* default */.Z, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
...
handler, args, relatedNative) {
  ...
  if ((!related || related !== target) && !(0,contains["default"])(target, related)) {
    handler(...args);
  }
}
...
/* harmony export */ });
/* unused harmony exports DEFAULT_BREAKPOINTS, DEFAULT_MIN_BREAKPOINT, useBootstrapBreakpoints, useBootstrapMinBreakpoint, createBootstrapComponent, ThemeConsumer */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7294);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7294);
/* harmony import */ var _ThemeProvider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6792);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9883);
/* harmony import */ var _getInitialPopperStyles__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3706);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5893);
"use client";
...
const Tooltip = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(({
  ...
  bsPrefix = (0,_ThemeProvider__WEBPACK_IMPORTED_MODULE_3__/* .useBootstrapPrefix */ .vE)(bsPrefix, 'tooltip');
  const isRTL = (0,_ThemeProvider__WEBPACK_IMPORTED_MODULE_3__/* .useIsRTL */ .SC)();
  const [primaryPlacement] = (placement == null ? void 0 : placement.split('-')) || [];
  const bsDirection = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__/* .getOverlayDirection */ .z)(primaryPlacement, isRTL);
  let computedStyle = style;
  if (show && !hasDoneInitialMeasure) {
    computedStyle = {
      ...style,
      ...(0,_getInitialPopperStyles__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)(popper == null ? void 0 : popper.strategy)
    };
  }
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Z: () => (/* binding */ getInitialPopperStyles)
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   z: () => (/* binding */ getOverlayDirection)
/* harmony export */ });
